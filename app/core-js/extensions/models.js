...
class Model extends Backbone.Model {
  ...
  canView(hideAlert) {
    ...
    if (
      !this.get("published") &&
      user.id == Mediakron.user.get("id") &&
      Mediakron.Access.check("can view own unpublished content")
    ) {
      return true;
    }
    if (
      !this.get("published") &&
      !Mediakron.Access.check("can view unpublished content")
    ) {
      if (!hideAlert)
        Mediakron.Access.denied("Sorry, you must login to view that page");
      return false;
    }
  ...
  canTransmit(alert) {
    if (!Mediakron.Access.check("can administer site")) {
      if (alert)
        Mediakron.Access.denied("Sorry, you must login to send content");
      return false;
    }
  ...
  canEdit(alert) {
    ...
    if (
      Mediakron.Access.check("can edit own content") &&
      user.id == Mediakron.user.get("id")
    ) {
      return true;
    }
    ...
    if (this.get("locked") === true) {
      ...
      if (alert)
        Mediakron.Access.denied(
          "This item is locked.  Please contact the author or an administrator to unlock."
        );
      return false;
    }
    if (Mediakron.Access.check("can edit any content")) {
  ...
  canPublish(alert) {
    ...
    if (alert)
      Mediakron.Access.denied("Sorry, you are not allowed to publish content");
    return false;
  }
  ...
  canArchive(alert) {
    ...
    if (alert)
      Mediakron.Access.denied("Sorry, you are not allowed to archive content");
    return false;
  }
  ...
  canUnpublish(alert) {
    ...
    if (alert)
      Mediakron.Access.denied(
        "Sorry, you are not allowed to unpublish content"
      );
    return false;
  }
  ...
  canDestroy(alert) {
    ...
    if (alert)
      Mediakron.Access.denied("Sorry, you are not allowed to delete content");
    return false;
  }
  ...
  getStatus() {
    ...
    if (!this.get("published")) {
      status =
        status +
        ' <span class="unpublished-append"><span class="mk-icon mk-unpublish"></span><span class="status-text">Unpublished</span></span>';
    }
    if (this.get("archived")) {
      status =
        status +
        ' <span class="archived-append"> <span class="mk-icon mk-archive"></span><span class="status-text">Archived</span></span>';
    }
    if (this.get("locked") && this.canEdit(false)) {
      status =
        status +
        ' <span class="locked-append tooltip--w" data-tooltip="This item is locked"> <span class="mk-icon mk-lock"></span><span class="status-text">Locked</span></span>';
    }
    ...
    switch (type) {
      ...
      case "audio":
        ...
        return (
          ...
          Mediakron.controller.getEditPath(uri) +
          this.get("uri")
        );
      default:
        return (
  ...
  editLink() {
    return Mediakron.Theme.link(
      '<span title="Edit" class="mk-icon mk-edit"></span>&nbsp;<span class="button-text">Edit</span>',
      this.editURL()
    );
  }
  downloadUrl() {
  ...
  transmitLink() {
    return Mediakron.Theme.link(
      '<span class="mk-icon mk-export transmit" title="Copy to Site" ></span>&nbsp;<span class="button-text">Copy to Site</span>',
      this.transmitUrl()
    );
  }
  ...
  duplicateLink() {
    return Mediakron.Theme.link(
      '<span class="mk-icon mk-duplicate duplicate" title="Duplicate" ></span>&nbsp;<span class="button-text">Duplicate</span>',
      this.duplicateUrl()
    );
  }
  ...
  publishLink() {
    if (this.canPublish(false))
      return Mediakron.Theme.link(
        '<span class="mk-icon mk-save publish" title="Publish" ></span>&nbsp;<span class="button-text">Publish</span>',
        this.publishURL()
      );
    return "";
  }
  ...
  unpublishLink() {
    if (this.canUnpublish(false))
      return Mediakron.Theme.link(
        '<span title="Unpublish" class="mk-icon mk-unpublish unpublish"></span>&nbsp;<span class="button-text">Unpublish</span>',
        this.unpublishURL()
      );
    return "";
  }
  ...
  archiveLink() {
    if (this.canArchive(false))
      return Mediakron.Theme.link(
        '<span class="mk-icon mk-archive unpublish" title="Archive" ></span>&nbsp;<span class="button-text">Archive</span>',
        this.archiveUrl()
      );
    return "";
  }
  ...
  restoreLink() {
    if (this.canArchive(false))
      return Mediakron.Theme.link(
        '<span title="Unarchive" class="mk-icon mk-undo restore"></span>&nbsp;<span class="button-text">Unarchive</span>',
        this.restoreUrl()
      );
    return "";
  }
  ...
  lockLink() {
    if (this.canLock(false))
      return Mediakron.Theme.link(
        '<span class="mk-icon mk-lock" title="Lock" ></span>&nbsp;<span class="button-text">Lock</span>',
        this.lockUrl()
      );
    return "";
  }
  ...
  unlockLink() {
    if (this.canLock(false))
      return Mediakron.Theme.link(
        '<span title="Unlock" class="mk-icon mk-unlocked"></span>&nbsp;<span class="button-text">Unlock</span>',
        this.unlockUrl()
      );
    return "";
  }
  ...
  deleteLink() {
    return Mediakron.Theme.link(
      '<span title="Delete" class="mk-icon mk-delete"></span>&nbsp;<span class="button-text">Delete</span>',
      this.deleteURL()
    );
  }
  ...
  getSquareImage(style, width, height, link) {
    ...
    if (image && (type != "file" || this.get("type") !== "text")) {
      if (image.uri) {
        ...
        if (link) {
          return (
            ...
            this.getURL() +
            '">' +
            Mediakron.Image.themeSquare(
              this.getStyledImage(style),
              this.get("title"),
              alt,
              "img-responsive",
              width,
          ...
          return Mediakron.Image.themeSquare(
            this.getStyledImage(style),
            this.get("title"),
            alt,
            "img-responsive",
      ...
      if (link) {
        return (
          ...
          '">' +
          Mediakron.Image.themeSquare(
            Mediakron.Image.style(text.url, style),
            this.get("title"),
            this.get("title"),
            "img-responsive",
            width,
    ...
    if (link) {
      return (
        '<a href="' +
        this.getURL() +
        '"><div class="item-square-icon" style="width:' +
        width +
        "px;height:" +
        height +
        "px;font-size:" +
        width * 0.9 +
        'px;"><span class="mk-icon ' +
        iconclass +
  ...
  getFeature(addClass) {
    ...
    return (
      ...
      '" uri="' +
      this.get("uri") +
      '" contenteditable="false" class="feature type-' +
      this.getNormalType() +
      " " +
      addClass +
      '" type="' +
