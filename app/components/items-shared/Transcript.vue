<template>
     <div class="item-element-transcript flex" v-if="isEditing">
        <b-form-group class="floating-label flex-1">
            ...
            <label for="transcript" class="text-base"> Transcript  <b-button v-b-modal.help-transcript variant="link" size="sm" class="pl-1">
                <font-awesome-icon icon="question-circle" class="text-black" /> <span class="sr-only"> About
                    Transcripts</span></b-button></label>
        </b-form-group>
    </div>
    <div v-else>
