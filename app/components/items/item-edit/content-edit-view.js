...
Mediakron.Admin.AddContentPage = Mediakron.Extensions.View.extend({
    ...
    setAudioFieldVisibility: function(type) {
        if (type == 'mp3') {
    ...
    initializeMapVisibility: function(type) {
        var model = this.model,
            changes = this.changes;
    ...
    openMetadata: function(e) {
        e.preventDefault();
        $('#metadata-form').addClass('is-visible');
        return false;
    },
    closeMetadata: function(e) {
        e.preventDefault();
