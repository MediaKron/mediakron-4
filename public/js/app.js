...
function Auth(callback) {
    var user;
    user = new __WEBPACK_IMPORTED_MODULE_0__core_js_models_user__["a" /* default */]();
    setGlobalUser(user);
    user.fetch({
        data: {
...
var User = function (_Model) {
  ...
  _createClass(User, [{
    ...
    key: "roleSelect",
    value: function roleSelect(role) {
    ...
    key: "changedContent",
    value: function changedContent() {}
  }, {
    key: "canEditItem",
    value: function canEditItem(type, item) {
